    ...
    try {
      ...
      if (currentStep === 1) {
        ...
        response = await apiService.post(
          "/accounts/auth/personal-register/",
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/90">
                      Create your personal workspace for individual project
                      management.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="space-y-4 bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-gray-600">
                            ...
                            Service and acknowledge that you have read and
                            understood them.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-gray-600">
                            You agree to our Privacy Policy and consent to the
              ...
              <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-500 p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/90">
                      Join an existing organization using an invitation link.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4 bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200">
                      <p className="text-sm text-gray-600 flex items-start gap-3">
                        ...
                        You should have received an invitation email with a
                        secure link. If you have an invitation token, enter it
                        below.
                      </p>
                      <div className="space-y-3">
                        <Label
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="backdrop-blur-sm bg-white/60 border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600">
                  Start personal or scale to enterprise. Add team members
                  anytime with our invitation system.
                </p>
              </CardContent>
            </Card>

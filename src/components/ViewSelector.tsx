    ...
    <TooltipProvider>
      <div className="flex-1 flex flex-col min-w-0 text-sharp">
        ...
        <div className="bg-background border-b border-border p-3 sm:p-4 flex-shrink-0 sticky top-0 z-50 relative overflow-hidden navbar-morph navbar-particles navbar-orbs navbar-no-blur">
          ...
          <div
            className="absolute bottom-0 right-0 w-48 h-48 bg-white/5 rounded-full translate-x-24 translate-y-24 float-animation"
            style={{ animationDelay: "2s" }}
          ></div>

          {/* Additional animated elements */}
          <div
            className="absolute top-1/4 right-1/4 w-32 h-32 bg-gradient-to-r from-cyan-400/20 to-blue-500/20 rounded-full blur-xl animate-pulse"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-1/4 left-1/4 w-24 h-24 bg-gradient-to-r from-purple-400/20 to-pink-500/20 rounded-full blur-lg animate-pulse"
        ...
        {/* Main Content Area */}
        <div className="flex-1 overflow-auto">{renderActiveView()}</div>
